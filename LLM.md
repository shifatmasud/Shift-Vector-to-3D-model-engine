...
-   `services/three.tsx`
-   `types/three.tsx`
-   `components/App/Shift.tsx`
-   `components/Core/Button.tsx`
-   `components/Core/ColorInput.tsx`
-   `components/Core/IconButton.tsx`
-   `components/Core/Loader.tsx`
-   `components/Core/RippleLayer.tsx`
-   `components/Core/Slider.tsx`
-   `components/Core/TabButton.tsx`
-   `components/Core/ThemeToggleButton.tsx`
-   `components/Package/ControlGroup.tsx`
-   `components/Package/EffectToggle.tsx`
-   `components/Package/FileUpload.tsx`
-   `components/Section/Scene.tsx`
-   `components/Section/Sidebar.tsx`
-   `components/Section/WelcomeStage.tsx`
-   `README.md`
-   `LLM.md`
-   `noteBook.md`
-   `bugReport.md`
...
1.  **Be a Tidy LEGO Builder**: Keep the code clean and organized. Follow the folder structure (`Core` -> `Package` -> `Section` -> `App`). Small, reusable pieces are better than big, messy ones.
