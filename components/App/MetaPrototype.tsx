...
const MetaPrototype = () => {
  ...
  const [windows, setWindows] = useState<Record<WindowId, WindowState>>({
    ...
    // Unused in MetaPrototype but required by WindowId type
    'shift-io': { id: 'shift-io', title: 'I/O', isOpen: false, zIndex: 0, x: 0, y: 0 },
    'shift-config': { id: 'shift-config', title: 'Config', isOpen: false, zIndex: 0, x: 0, y: 0 },
    'shift-effects': { id: 'shift-effects', title: 'Effects', isOpen: false, zIndex: 0, x: 0, y: 0 },
  });
